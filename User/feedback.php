...
if(isset($_POST["submit"]))
{
  ...
  $exe = $con->query("insert into feedback(Customer_id,Message,Date,agency_id,ratings) values('$id','$message','$date','$agencyname','$rate')");
            ...
            <form action="#" method="post" class="p-5 bg-white">
              ...
              <div class="row form-group">
                ...
                <div class="col-md-12 mb-3 mb-md-0">
                          ...
                          <select name="agencyname" id="size" class="form-control" required="">
